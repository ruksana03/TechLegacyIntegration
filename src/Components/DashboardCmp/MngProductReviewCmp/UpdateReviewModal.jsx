...
const features = ['Make Featured', 'Featured'];

const UpdateReviewModal = ({ setIsOpen, isOpen, modalHandlerProductReview, eachProduct }) => {
    const [selected, setSelected] = useState(eachProduct.featured);
                ...
                <Dialog.Panel className='w-full h-56 max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all'>
                  ...
                  <div className='flex mt-2 justify-center gap-5'>
                    <button
                      ...
                      onClick={() =>  modalHandlerProductReview(selected)}
                    >
                    Update Featured
                    </button>
                    <button
